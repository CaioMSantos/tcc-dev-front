...
export const environment = {
  ...
  apiUrl: 'https://gw.consultatributaria.com.br',
  apiConvertFiles: 'https://gw.consultatributaria.com.br/export-file/api',
  taxDiagnosisAPI: 'https://api-dfiscal.consultatributaria.com.br',
  appDemos: {
    'demo1': {
      'title': 'Demo 1',
